...
class Debugger(object):
  def __init__(self, ipynb=False, theme='black', 
    ...
    elif num_classes == 10 or dataset == 'visdrone2019':
      self.names = visdrone2019_class_name
    elif num_classes == 3 or dataset == 'uavdt':
...
visdrone2019_class_name = [
   'pedestrian', 'people', 'bicycle', 'car', 
  'van', 'truck', 'tricycle', 'awning-tricycle', 'bus', 'motor'
]
dota_class_name = [
            "soccer-ball-field", "helicopter","swimming-pool",
            "roundabout","large-vehicle","small-vehicle",
            "bridge","harbor","ground-track-field",
            "basketball-court","tennis-court","baseball-diamond",
            "storage-tank","ship","plane","container-crane"
]

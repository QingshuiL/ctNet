...
import numpy as np
import pickle
IMG_PATH = 'C:/Users/10295/CV/CenterNet-master/data/visdrone2019/bbox/'
ANN_PATH = 'C:/Users/10295/CV/CenterNet-master/exp/ctdet/visdrone2019_dla34/results.json'
DEBUG = True
...
if __name__ == '__main__':
  ...
  for i, img_id in enumerate(img_ids):
    ...
    cv2.imwrite('{}vis/{}.jpg'.format(IMG_PATH,img_id), gt_img)
    '''
    k = cv2.waitKey()
    if k==27:
      break
